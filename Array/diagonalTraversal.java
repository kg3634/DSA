...
The guides follow a prescribed route of visiting the monuments which improves them understand the relevance of each 
monument. The route of the monument is fixed and expressed in a 2-d matrix where the travellers visit the prescribed 
next monument. For example
1  2  3
4  5  6
7  8  9
...
For details check image.images/diagonalTraversal.png
Constraints
1 <= n <= 10^2
...
public class diagonalTraversal {
    public static void main(String[] args) {
        ...
        //Logic:images/dioginallogic.png
        for( int g=0;g<arr.length;g++){//gap is increasing between diaogonal elem moving up
            for(int i = 0,j=g;j<arr.length;i++,j++){//i is starting with 0 and j with gap, both increasing and ending with 
                //right wall means 
